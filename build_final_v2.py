...
# 4. Measure text FIRST so we know the target height
...
# 5. Resize icon to match text height (so they're equal)
target_h = text_h + 4  # just a tiny bit taller than text
...
print(f"Icon h={target_h}, Text h={text_h}, Final={final_w}x{final_h}")
print("DONE")
