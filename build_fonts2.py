...
FONTS = {
    "Nunito-Black.ttf":    "https://raw.githubusercontent.com/googlefonts/nunito/refs/heads/main/fonts/TTF/Nunito-Black.ttf",
    "Nunito-Regular.ttf":  "https://raw.githubusercontent.com/googlefonts/nunito/refs/heads/main/fonts/TTF/Nunito-Regular.ttf",
    "Raleway-ExtraBold.ttf": "https://raw.githubusercontent.com/googlefonts/Raleway/refs/heads/master/fonts/TTF/Raleway-ExtraBold.ttf",
    "Raleway-Regular.ttf":   "https://raw.githubusercontent.com/googlefonts/Raleway/refs/heads/master/fonts/TTF/Raleway-Regular.ttf",
}
...
def make_logo(bold_path, med_path, label, out_name):
    try:
        fb = ImageFont.truetype(bold_path, 70)
        fm = ImageFont.truetype(med_path, 37)
    except Exception as e:
        print(f"Font error: {e}"); return
    ...
    GAP=20; M=25
    cw = M+icon_final.width+GAP+text_w+M; ch = max(TARGET_H,text_h)+M*2
...
if os.path.exists("Nunito-Black.ttf"):
    make_logo("Nunito-Black.ttf",   "Nunito-Regular.ttf",    "1. Nunito Black",     BASE+"FONT_1_Nunito.png")
if os.path.exists("Raleway-ExtraBold.ttf"):
    make_logo("Raleway-ExtraBold.ttf","Raleway-Regular.ttf", "3. Raleway ExtraBold",BASE+"FONT_3_Raleway.png")
