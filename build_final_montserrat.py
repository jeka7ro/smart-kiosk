...
# 1. Load icon - DO NOT CROP THE STAND
...
# Keep the FULL icon intact (don't cut anything!)
# Just resize the whole thing to match text height

# 2. Font: Montserrat (confirmed by user)
f_bold = ImageFont.truetype("Montserrat-Bold.ttf", 48)
f_bold.set_variation_by_axes([700])
f_light = ImageFont.truetype("Montserrat-Bold.ttf", 26)
f_light.set_variation_by_axes([400])
...
# 4. Resize icon to match text height exactly - keep full proportions
target_h = text_h
...
# Save all versions
canvas.save(BASE + "FINAL_MONTSERRAT.png")

cw = Image.new("RGBA", (final_w, final_h), (255, 255, 255, 255))
cw.paste(canvas, (0, 0), canvas)
cw.save(BASE + "FINAL_MONTSERRAT_WHITE.png")
...
canvas_wt.save(BASE + "FINAL_MONTSERRAT_WHITE_TEXT.png")

cn = Image.new("RGBA", (final_w, final_h), (12, 43, 78, 255))
cn.paste(canvas_wt, (0, 0), canvas_wt)
cn.save(BASE + "FINAL_MONTSERRAT_NAVY.png")
