                  ...
                  <div className="iphone-screen">
                    ...
                    <div className="iphone-apple-pay-content">
                      <div className="iphone-apple-logo-row">
                        <svg width="14" height="17" viewBox="0 0 17 21" fill="#ffffff">
                          <path d="M12.9 10.6c-.03-2.5 2.03-3.7 2.12-3.76-1.16-1.7-2.96-1.93-3.6-1.96-1.53-.16-3 .9-3.78.9-.78 0-1.99-.88-3.27-.86-1.68.03-3.23.98-4.1 2.48-1.75 3.03-.45 7.51 1.25 9.97.83 1.2 1.82 2.54 3.12 2.49 1.25-.05 1.73-.81 3.24-.81 1.51 0 1.95.81 3.26.78 1.34-.02 2.2-1.22 3.02-2.42.95-1.39 1.34-2.74 1.36-2.81-.03-.01-2.6-1-2.62-3.98zM10.8 3.5c.69-.83 1.15-1.99 1.02-3.15-.99.04-2.19.66-2.9 1.49-.63.73-1.18 1.9-1.03 3.03 1.1.09 2.22-.54 2.91-1.37z" />
                        </svg>
