...
export default function MenuScreen() {
  ...
  const activeBrandLogo = BRANDS[activeBrandId]?.logoImg || brand?.logoImg || (activeBrandId ? `/brands/${activeBrandId}-logo.png` : null);
  const activeBrandName = BRANDS[activeBrandId]?.name || brand?.name || '';
    ...
    <div className={`menu-screen fade-in ui-size-${(locationData?.kioskUiSize || 'S').toLowerCase()}`}>
      ...
      <header className="menu-header">
        ...
        <div className="menu-search">
          {/* Diets buttons removed per request */}
          <input
            type="text"
