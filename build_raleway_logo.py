...
w, h = icon.size
icon = icon.crop((0, 0, w, h - int(h * 0.15)))

f_bold = ImageFont.truetype("Raleway-Bold.ttf", 48)
f_bold.set_variation_by_axes([700])
f_light = ImageFont.truetype("Raleway-Bold.ttf", 26)
